...
describe('BirthInfoForm', () => {
  ...
  describe('Rendering', () => {
    it('should render all form fields', () => {
      render(<BirthInfoForm value={{}} onChange={mockOnChange} />);
    ...
    it('should render gender buttons when showGender is true', () => {
      render(<BirthInfoForm value={{}} onChange={mockOnChange} showGender={true} />);
    ...
    it('should not render gender buttons when showGender is false', () => {
      render(<BirthInfoForm value={{}} onChange={mockOnChange} showGender={false} />);
  ...
  describe('onChange callback', () => {
    it('should call onChange when year changes', () => {
      render(<BirthInfoForm value={{ year: 2000, month: 1, day: 1, hour: 12, minute: 0, timezone: 'Asia/Shanghai' }} onChange={mockOnChange} />);
    ...
    it('should call onChange when gender changes', () => {
      render(<BirthInfoForm value={{ gender: 'male' }} onChange={mockOnChange} showGender={true} />);
  ...
  describe('Date handling edge cases', () => {
    it('should adjust days when switching from January to April (31 -> 30)', () => {
      ...
      render(<BirthInfoForm value={initialValue} onChange={mockOnChange} />);

      const monthSelect = screen.getByLabelText('月份');
      fireEvent.change(monthSelect, { target: { value: 4 } }); // April

      // Day should be clamped to 30 since April has 30 days
    ...
    it('should handle February in leap year correctly (29 days)', () => {
      ...
      const monthSelect = screen.getByLabelText('月份');
      fireEvent.change(monthSelect, { target: { value: 2 } }); // February
